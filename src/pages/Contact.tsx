...
export const Contact = () => (
  <Page
    title="Contact"
    description="Artwork for acquisition, exhibition and reproduction by Frances Kornbluth, an American painter who spent 57 summers working on Monhegan Island off the coast of Maine."
  >
    <Row>
      <Col md={9}>
        <H1>Contact</H1>
